...
3. For a **new** component/token: confirm it serves a real, repeated need (≥ 2 places) before promoting product → candidate → core. Design it to the full quality bar (AGENTS.md Component Quality Bar).
...
5. Wire any new file into `AGENTS.md` (File Reference Map + relevant table/router) and add a changelog entry.
